...
// accordion interaction performance.
      ...
      <li className="FAQHome__question">
        ...
        {isActive && (
          <div
            ...
            // ⚡ Bolt Optimization: Kept lazy evaluation of sanitizeHtml
            // inside conditional rendering so it only executes when active.
...
export default function FAQHome({ title, description, questions }: Props) {
  ...
  // ⚡ Bolt Optimization: Memoized main description's sanitizeHtml call
  // to avoid expensive recalculations (~0.8ms per call) during re-renders.
