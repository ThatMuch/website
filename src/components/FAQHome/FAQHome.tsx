...
// toggles a single question, saving expensive DOM updates and improving
// expand/collapse interaction performance.
      ...
      <li className="FAQHome__question">
        ...
        {isActive && (
          <div
            ...
            // ⚡ Bolt Optimization: Lazily evaluate expensive sanitizeHtml ONLY when active
...
export default function FAQHome({ title, description, questions }: Props) {
  ...
  // ⚡ Bolt Optimization: Memoized the result of sanitizeHtml to avoid
  // expensive re-calculations (~0.8ms per call) during re-renders caused by activeIndex changes.
